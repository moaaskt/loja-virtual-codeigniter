        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="mx-auto my-2 my-lg-0">
                    ...
                    <input class="form-control me-2" type="search" name="termo" placeholder="Buscar produtos..."
                        aria-label="Buscar" value="<?= esc(isset($termoBusca) ? $termoBusca : '') ?>">
                    ...
                    <?php if (session()->get('isLoggedIn')): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="<?= site_url('minha-conta/pedidos') ?>">Meus Pedidos</a>
                                </li>
                                <?php if (session()->get('role') === 'admin'): ?>
                                    <li><a class="dropdown-item" href="<?= site_url('admin/dashboard') ?>">Painel Admin</a></li>
                                <?php endif; ?>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item text-danger" href="<?= site_url('logout') ?>">Sair (Logout)</a>
                                </li>
                            </ul>
                        </li>
                    <?php else: ?>
