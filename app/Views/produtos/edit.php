...
<?= form_open_multipart('produtos/update/' . $produto['id']) ?>
...
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <input type="number" step="0.01" name="preco" id="preco" class="form-control"
            value="<?= old('preco', $produto['preco']) ?>" placeholder="19.99">
    </div>
    <div class="col-md-6 mb-3">
...
<div class="row mb-3">
    ...
    <div class="col-md-6 text-center">
        ...
        <?php if (!empty($produto['imagem'])): ?>
            <img src="<?= base_url('uploads/produtos/' . esc($produto['imagem'])) ?>" alt="<?= esc($produto['nome']) ?>"
                height="100">
        <?php else: ?>
